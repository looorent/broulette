/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e8468908b0bc8cc003a40928e1989d9e)
...
declare namespace Cloudflare {
	...
	interface Env {
		BROULETTE_NOMINATIM_INSTANCE_URLS: "https://nominatim.openstreetmap.org";
		BROULETTE_NOMINATIM_USER_AGENT: "BiteRoulette/0.0.1";
		...
		BROULETTE_PHOTON_INSTANCE_URLS: "https://photon.komoot.io";
		...
		BROULETTE_GOOGLE_PLACE_BASE_URL: "https://maps.googleapis.com/maps/api/place";
		...
		BROULETTE_GOOGLE_PLACE_API_CLOSE_AFTER: "10";
		BROULETTE_GOOGLE_PLACE_API_CONSECUTIVE_FAILURES: "5";
		BROULETTE_TRIPADVISOR_INSTANCE_URL: "https://api.content.tripadvisor.com/api/v1/location";
		...
		BROULETTE_OVERPASS_API_INSTANCE_URLS: "https://overpass-api.de/api/interpreter";
		...
		BROULETTE_SEARCH_ENGINE_DISCOVERY_RANGE_INCREASE_METERS: "500";
		BROULETTE_SEARCH_ENGINE_MAX_DISCOVERY_ITERATIONS: "5";
		BROULETTE_TAGS_TO_EXCLUDE: "fast_food,chain";
		BROULETTE_TAGS_TO_PRIORITIZE: "restaurant,cafe";
		BROULETTE_TAGS_MAXIMUM: "20";
		BROULETTE_SEARCH_ENGINE_CLOSE_RANGE_IN_METERS: "500";
		BROULETTE_SEARCH_ENGINE_CLOSE_TIMEOUT_IN_MS: "2000";
		BROULETTE_SEARCH_ENGINE_MID_RANGE_IN_METERS: "2000";
		BROULETTE_SEARCH_ENGINE_MID_TIMEOUT_IN_MS: "4000";
		BROULETTE_SEARCH_ENGINE_FAR_RANGE_IN_METERS: "5000";
		BROULETTE_SEARCH_ENGINE_FAR_TIMEOUT_IN_MS: "8000";
		...
		BROULETTE_SESSION_SECRET: string;
		BROULETTE_SESSION_SECURE: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BROULETTE_NOMINATIM_INSTANCE_URLS" | "BROULETTE_NOMINATIM_USER_AGENT" | "BROULETTE_NOMINATIM_BOTTOM_NOTE" | "BROULETTE_NOMINATIM_NUMBER_0F_ADDRESSES" | "BROULETTE_NOMINATIM_API_RETRIES" | "BROULETTE_NOMINATIM_API_TIMEOUT" | "BROULETTE_NOMINATIM_API_CLOSE_AFTER" | "BROULETTE_NOMINATIM_CONSECUTIVE_FAILURES" | "BROULETTE_PHOTON_INSTANCE_URLS" | "BROULETTE_PHOTON_BOTTOM_NOTE" | "BROULETTE_PHOTON_NUMBER_0F_ADDRESSES" | "BROULETTE_PHOTON_API_RETRIES" | "BROULETTE_PHOTON_API_TIMEOUT" | "BROULETTE_PHOTON_API_CLOSE_AFTER" | "BROULETTE_PHOTON_CONSECUTIVE_FAILURES" | "BROULETTE_GOOGLE_PLACE_BASE_URL" | "BROULETTE_GOOGLE_PLACE_API_MAX_NUMBER_OF_ATTEMPTS_PER_MONTH" | "BROULETTE_GOOGLE_PLACE_API_SEARCH_RADIUS_IN_METERS" | "BROULETTE_GOOGLE_PLACE_API_PHOTO_MAX_WIDTH_IN_PX" | "BROULETTE_GOOGLE_PLACE_API_PHOTO_MAX_HEIGHT_IN_PX" | "BROULETTE_GOOGLE_PLACE_API_SIMILARITY_WEIGHT_NAME" | "BROULETTE_GOOGLE_PLACE_API_SIMILARITY_WEIGHT_LOCATION" | "BROULETTE_GOOGLE_PLACE_API_RETRIES" | "BROULETTE_GOOGLE_PLACE_API_TIMEOUT" | "BROULETTE_GOOGLE_PLACE_API_CLOSE_AFTER" | "BROULETTE_GOOGLE_PLACE_API_CONSECUTIVE_FAILURES" | "BROULETTE_TRIPADVISOR_INSTANCE_URL" | "BROULETTE_TRIPADVISOR_API_MAX_NUMBER_OF_ATTEMPTS_PER_MONTH" | "BROULETTE_TRIPADVISOR_API_SEARCH_RADIUS_IN_METERS" | "BROULETTE_TRIPADVISOR_API_SIMILARITY_WEIGHT_NAME" | "BROULETTE_TRIPADVISOR_API_SIMILARITY_WEIGHT_LOCATION" | "BROULETTE_TRIPADVISOR_API_SEARCH_MIN_SCORE_TRESHOLD" | "BROULETTE_TRIPADVISOR_API_PHOTO_SIZE" | "BROULETTE_TRIPADVISOR_API_RETRIES" | "BROULETTE_TRIPADVISOR_API_TIMEOUT" | "BROULETTE_TRIPADVISOR_API_CLOSE_AFTER" | "BROULETTE_TRIPADVISOR_API_CONSECUTIVE_FAILURES" | "BROULETTE_OVERPASS_API_INSTANCE_URLS" | "BROULETTE_OVERPASS_API_RETRIES" | "BROULETTE_OVERPASS_API_TIMEOUT" | "BROULETTE_OVERPASS_API_CLOSE_AFTER" | "BROULETTE_OVERPASS_API_CONSECUTIVE_FAILURES" | "BROULETTE_SEARCH_ENGINE_DISCOVERY_RANGE_INCREASE_METERS" | "BROULETTE_SEARCH_ENGINE_MAX_DISCOVERY_ITERATIONS" | "BROULETTE_TAGS_TO_EXCLUDE" | "BROULETTE_TAGS_TO_PRIORITIZE" | "BROULETTE_TAGS_MAXIMUM" | "BROULETTE_SEARCH_ENGINE_CLOSE_RANGE_IN_METERS" | "BROULETTE_SEARCH_ENGINE_CLOSE_TIMEOUT_IN_MS" | "BROULETTE_SEARCH_ENGINE_MID_RANGE_IN_METERS" | "BROULETTE_SEARCH_ENGINE_MID_TIMEOUT_IN_MS" | "BROULETTE_SEARCH_ENGINE_FAR_RANGE_IN_METERS" | "BROULETTE_SEARCH_ENGINE_FAR_TIMEOUT_IN_MS" | "BROULETTE_DATABASE_URL" | "BROULETTE_GOOGLE_PLACE_API_KEY" | "BROULETTE_NOMINATIM_ENABLED" | "BROULETTE_PHOTON_ENABLED" | "BROULETTE_OVERPASS_ENABLED" | "BROULETTE_GOOGLE_PLACE_ENABLED" | "BROULETTE_TRIPADVISOR_ENABLED" | "BROULETTE_TRIPADVISOR_API_KEY" | "BROULETTE_SESSION_SECRET" | "BROULETTE_SESSION_SECURE">> {}
}
