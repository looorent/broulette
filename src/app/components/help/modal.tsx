      ...
      actions={
        <button
          ...
          className={`
            ...
            rounded-md border-2 border-fun-dark bg-fun-dark px-4 py-2 font-pop
        ...
        `}>
          ...
          {activeTab === "about" && (
            <section className="space-y-6 text-center">
              ...
              `}>
                <h3 className={`
                  mb-3 border-b border-fun-dark/10 pb-2 text-center text-xs
              ...
              <div className="pt-2 font-display text-lg text-fun-dark">
          ...
          {activeTab === "legal" && (
            <section className="space-y-6 text-left">
              ...
              {/* Liability */}
              <div className={`
                flex items-start gap-3 rounded-lg border border-orange-200
                bg-orange-50 p-4
              `}>
                <AlertTriangle className="h-6 w-6 shrink-0 text-orange-500" />
                <div>
                  <h4 className={`
                    mb-1 text-sm font-bold tracking-wide text-orange-800
                    uppercase
              ...
              <div className="pt-8 text-center opacity-30">
                <p className="font-mono text-[10px] tracking-widest uppercase">v{configuration.version}</p>
              </div>
            </section>
          )}
