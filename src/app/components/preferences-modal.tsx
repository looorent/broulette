...
import { CalendarPlus, Check, ChefHat, Clock, Crosshair, Dices, MapPin, Moon, Sun, UtensilsCrossed, XCircle, type LucideProps } from "lucide-react";
...
return (
    <dialog id="settings-modal"
            className="flex flex-col fixed inset-0 z-100 items-center justify-end py-0 px-2 backdrop-blur-sm w-full h-full border-none m-0 max-w-full max-h-full bg-transparent"
            open>
        <div className="bg-fun-cream w-full sm:max-w-md border-x-2 border-t-4 border-fun-dark rounded-t-3xl sm:rounded-3xl p-6 pb-10 
                    shadow-hard relative mx-auto animate-slide-up max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <Link to="." className="text-fun-dark hover:scale-110 transition-transform" aria-label="Close Settings">
