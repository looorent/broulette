...
export class OsmServerError extends OsmError {
  constructor(
    ...
    super(
      `[OSM] Fetching all OSM restaurants: server failed after ${durationInMs} ms with status code ${responseStatusCode}`,
      query,
      responseStatusCode,
      responseBody,
      durationInMs
...
export class OsmHttpError extends OsmError {
  constructor(
    ...
    super(
      `[OSM] Fetching all OSM restaurants: http call failed after ${durationInMs} ms with status code ${responseStatusCode}`,
      query,
      responseStatusCode,
      responseBody,
      durationInMs
...
export class OsmEmptyResponseError extends OsmError {
  constructor(
    ...
    super(
      `[OSM] Fetching all OSM restaurants: empty response after ${durationInMs} ms with status code ${responseStatusCode}`,
      query,
      responseStatusCode,
      responseBody,
      durationInMs
